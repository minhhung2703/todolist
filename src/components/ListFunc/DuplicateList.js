...
export default function DuplicateList({ visible, onClose }) {
    const handleOnClose = (e) => {
      if (e.target.id === "DuplicateList") onClose();
    };
    ...
    return (
      ...
      >
        <form method="POST" className="max-w-xl bg-slate-800/50 h-auto px-6 py-4 rounded-lg">
          <p className="text-xl font-bold pb-5">Duplicate List</p>
          <div className="flex items-center space-x-3">
            <input
              type="text"
              placeholder="Duplicate list"
